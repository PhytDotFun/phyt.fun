...
function SidebarInput({
    ...
    return (
        <Input
            ...
            data-sidebar="input"
            className={cn(
                "bg-sidebar h-8 w-full shadow-none",
                className,
            )}
            {...props}
        />
